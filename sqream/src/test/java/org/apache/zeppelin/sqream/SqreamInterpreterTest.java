 ...
 * the License.
 */
package org.apache.zeppelin.sqream;

import static org.apache.zeppelin.sqream.SqreamInterpreter.DEFAULT_JDBC_DRIVER_NAME;
import static org.apache.zeppelin.sqream.SqreamInterpreter.DEFAULT_JDBC_URL;
import static org.apache.zeppelin.sqream.SqreamInterpreter.DEFAULT_JDBC_USER_NAME;
import static org.apache.zeppelin.sqream.SqreamInterpreter.DEFAULT_JDBC_USER_PASSWORD;
import static org.apache.zeppelin.sqream.SqreamInterpreter.DEFAULT_MAX_RESULT;
import static org.apache.zeppelin.sqream.SqreamInterpreter.SQREAM_SERVER_DRIVER_NAME;
import static org.apache.zeppelin.sqream.SqreamInterpreter.SQREAM_SERVER_MAX_RESULT;
import static org.apache.zeppelin.sqream.SqreamInterpreter.SQREAM_SERVER_PASSWORD;
import static org.apache.zeppelin.sqream.SqreamInterpreter.SQREAM_SERVER_URL;
import static org.apache.zeppelin.sqream.SqreamInterpreter.SQREAM_SERVER_USER;
...
/**
 * Sqream interpreter unit tests
 */
public class SqreamInterpreterTest extends BasicJDBCTestCaseAdapter {

  private SqreamInterpreter psqlInterpreter = null;
  ...
  public void beforeTest() {
    ...
    properties.put(SQREAM_SERVER_DRIVER_NAME, DEFAULT_JDBC_DRIVER_NAME);
    properties.put(SQREAM_SERVER_URL, DEFAULT_JDBC_URL);
    properties.put(SQREAM_SERVER_USER, DEFAULT_JDBC_USER_NAME);
    properties.put(SQREAM_SERVER_PASSWORD, DEFAULT_JDBC_USER_PASSWORD);
    properties.put(SQREAM_SERVER_MAX_RESULT, DEFAULT_MAX_RESULT);

    psqlInterpreter = spy(new SqreamInterpreter(properties));
  ...
  public void testDefaultProperties() throws SQLException {
    ...
    SqreamInterpreter psqlInterpreter = new SqreamInterpreter(new Properties());

    assertEquals(DEFAULT_JDBC_DRIVER_NAME,
        psqlInterpreter.getProperty(SQREAM_SERVER_DRIVER_NAME));
    assertEquals(DEFAULT_JDBC_URL, psqlInterpreter.getProperty(SQREAM_SERVER_URL));
    assertEquals(DEFAULT_JDBC_USER_NAME, psqlInterpreter.getProperty(SQREAM_SERVER_USER));
    assertEquals(DEFAULT_JDBC_USER_PASSWORD,
        psqlInterpreter.getProperty(SQREAM_SERVER_PASSWORD));
    assertEquals(DEFAULT_MAX_RESULT, psqlInterpreter.getProperty(SQREAM_SERVER_MAX_RESULT));
  }

  @Test
  public void testConnectionClose() throws SQLException {

    SqreamInterpreter psqlInterpreter = spy(new SqreamInterpreter(new Properties()));
